...
--[[
  Panel Client v3 â€” Headless (no GUI)
...
local function Main()
    ...
    subTitleLbl.BackgroundTransparency = 1; subTitleLbl.Text = "powered by luck ًںچ€"
    ...
    closeBtn.Text = "أ—"; closeBtn.TextColor3 = C.topBtn; closeBtn.Font = Enum.Font.GothamBlack; closeBtn.TextSize = 18
    ...
    local function getKeyDisplayName(kc)
        ...
        local gpNames = {ButtonA="A",ButtonB="B",ButtonX="X",ButtonY="Y",ButtonL1="LB",ButtonL2="LT",ButtonL3="LS",
            ...
            DPadUp="Dâ†‘",DPadDown="Dâ†“",DPadLeft="Dâ†گ",DPadRight="Dâ†’",Thumbstick1="LS",Thumbstick2="RS"}
    ...
    local function makeKeybindRow(label, currentKey, onChanged, keyName)
        ...
        kbtn.MouseButton1Click:Connect(function()
            ...
            listening = true; kbtn.Text = "آ·آ·آ·"; kbtn.TextColor3 = Color3.fromRGB(0,30,12)
    ...
    do
        local page = buildPage("Visual", function()
            ...
            local cleanBtn = Instance.new("TextButton", cleanBtnWrap); cleanBtn.Size = UDim2.new(1,0,0,32); cleanBtn.Position = UDim2.new(0,0,0,7); cleanBtn.BackgroundColor3=C.btnBg; cleanBtn.BorderSizePixel=0; cleanBtn.Text="ًں§¹ Clean Particles & Lights"; cleanBtn.TextColor3=C.btnTxt; cleanBtn.Font=Enum.Font.GothamBold; cleanBtn.TextSize=12; mkCorner(cleanBtn,6); mkStroke(cleanBtn, C.btnBorder,1)
    ...
    do
        local page = buildPage("Settings", function()
            ...
            saveBtn.MouseButton1Click:Connect(function()
                ...
                if success then saveBtn.Text="âœ“  Saved!"; saveBtn.BackgroundColor3=Color3.fromRGB(46,180,100) else saveBtn.Text="âœ—  Save Failed"; saveBtn.BackgroundColor3=Color3.fromRGB(180,60,60) end
                task.delay(2.5,function() if saveBtn and saveBtn.Parent then saveBtn.Text="ًں’¾  Save Config Now"; saveBtn.BackgroundColor3=C.accent end end)
            end)
            ...
            local resetAllBtn = Instance.new("TextButton", resetWrap); resetAllBtn.Size = UDim2.new(1,-28,0,32); resetAllBtn.Position = UDim2.new(0,14,0,7); resetAllBtn.BackgroundColor3=Color3.fromRGB(80,25,25); resetAllBtn.BorderSizePixel=0; resetAllBtn.Text="âڑ   Reset All Settings"; resetAllBtn.TextColor3=Color3.fromRGB(255,200,200); resetAllBtn.Font=Enum.Font.GothamBold; resetAllBtn.TextSize=12; resetAllBtn.ZIndex=5; mkCorner(resetAllBtn,6); mkStroke(resetAllBtn, Color3.fromRGB(130,45,45),1)
            ...
            resetAllBtn.MouseButton1Click:Connect(function()
                if _resetConfirmStage==0 then
                    _resetConfirmStage=1; resetAllBtn.Text="âڑ   Click again to confirm!"; resetAllBtn.BackgroundColor3=Color3.fromRGB(160,50,50)
                    if _resetConfirmTimer then task.cancel(_resetConfirmTimer) end
                    _resetConfirmTimer = task.delay(3,function() if resetAllBtn and resetAllBtn.Parent then _resetConfirmStage=0; resetAllBtn.Text="âڑ   Reset All Settings"; resetAllBtn.BackgroundColor3=Color3.fromRGB(80,25,25) end end)
                    return
                end
                ...
                resetAllBtn.Text="âœ“  All Settings Reset!"; resetAllBtn.BackgroundColor3=Color3.fromRGB(46,160,90)
                task.delay(2,function() if resetAllBtn and resetAllBtn.Parent then resetAllBtn.Text="âڑ   Reset All Settings"; resetAllBtn.BackgroundColor3=Color3.fromRGB(80,25,25) end end)
            end)
            ...
            local resetBtn = Instance.new("TextButton", rWrap); resetBtn.Size = UDim2.new(1,-28,0,32); resetBtn.Position = UDim2.new(0,14,0,7); resetBtn.BackgroundColor3=C.btnBg; resetBtn.BorderSizePixel=0; resetBtn.Text="â†؛  Reset Button Positions"; resetBtn.TextColor3=C.btnTxt; resetBtn.Font=Enum.Font.GothamBold; resetBtn.TextSize=12; resetBtn.ZIndex=5; mkCorner(resetBtn,6); mkStroke(resetBtn, C.btnBorder,1)
            ...
            resetBtn.MouseButton1Click:Connect(function()
                for i,def in ipairs(stackDefs) do local wrapper=stackWrappers[def.key]; if wrapper then TweenService:Create(wrapper,TweenInfo.new(0.35,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{Position=getDefaultStackPos(i)}):Play() end end
                resetBtn.Text="âœ“  Positions Reset!"; task.delay(1.8,function() if resetBtn and resetBtn.Parent then resetBtn.Text="â†؛  Reset Button Positions" end end)
            end)
            makeGap(10)
            ...
            local fl = Instance.new("TextLabel", fw); fl.Size = UDim2.new(1,0,1,0); fl.BackgroundTransparency=1; fl.Text="Green Duels  آ·  powered by luck ًںچ€"; fl.TextColor3=Color3.fromRGB(50,100,65); fl.Font=Enum.Font.Gotham; fl.TextSize=10; fl.TextXAlignment=Enum.TextXAlignment.Center
            ...
            _G._VezyFlashSave = function(success)
                ...
                if success then lbl.Text="âœ“  Auto-saved"; lbl.TextColor3=Color3.fromRGB(46,200,120)
                else lbl.Text="âœ—  Save failed"; lbl.TextColor3=Color3.fromRGB(220,80,80) end
                task.delay(1.5,function() if lbl and lbl.Parent then lbl.Text="Green Duels  آ·  powered by luck ًںچ€"; lbl.TextColor3=Color3.fromRGB(50,100,65) end end)
            end
        end)
        page.LayoutOrder = 6
    end
    ...
    pingIcon.BackgroundTransparency=1; pingIcon.Text="ًں“،"; pingIcon.TextColor3=Color3.fromRGB(180,220,200)
